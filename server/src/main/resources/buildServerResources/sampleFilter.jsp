...
<div class="agentsFilter" id="usersFilter${graphKey}">
  <div>
    <div>
      <a href="#" onclick="setBoxes('${graphKey}', false); return false" style="float: right; margin-left:10px;">None</a>
      <a href="#" onclick="setBoxes('${graphKey}', true); applyFilter('${graphKey}'); return false" style="float: right; margin-left:10px;">All</a>
